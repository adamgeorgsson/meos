...
// Internal helpers shared between oRunnerData.cpp and oRunnerResult.cpp.
// Both files include all needed headers (oControl.h, gdioutput.h, gdifonts.h,
// meos_util.h) before this header, so no additional includes are needed here.
