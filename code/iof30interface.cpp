...
#endif
      wchar_t bf[64];
      swprintf(bf, sizeof(bf)/sizeof(wchar_t), L"%02d:%02d:%02d", localTime.tm_hour, localTime.tm_min, localTime.tm_sec);
      timeOut = bf;
      swprintf(bf, sizeof(bf)/sizeof(wchar_t), L"%d-%02d-%02d", localTime.tm_year+1900, localTime.tm_mon+1, localTime.tm_mday);
      dateOut = bf;
    }
    else {
      dateOut = date;
